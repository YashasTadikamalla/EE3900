...
\end{definition}
\begin{theorem}
For a hyperbola, the length of latus rectum (LLR) is given by
\begin{align}
    \label{eq:LLR}
        LLR=\dfrac{2\brak{\dfrac{f-\vec{u}^{\top}\vec{V}^{-1}\vec{u}}{\lambda_2}}}{\sqrt{\dfrac{\vec{u}^{\top}\vec{V}^{-1}\vec{u} -f}{\lambda_1}}}
\end{align}
\end{theorem}
