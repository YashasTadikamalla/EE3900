...
\begin{lstlisting}
https://github.com/YashasTadikamalla/EE3900/blob/main/Assignment3/codes
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/YashasTadikamalla/EE3900/blob/main/Assignment3/Assignment3.tex
\end{lstlisting}
\section{Problem (Ramsey/4.4 Systems of circles/Q4 (a)}
...
\begin{align}
&S=\vec{x}^{T}\vec{x}-\myvec{4 & -5}\vec{x}-2=0\label{eq:1}\\
&S'=\vec{x}^{T}\vec{x}-\myvec{5 & -6}\vec{x}=0\label{eq:2}
\end{align}
We know, the radical axis for the pair of circles, $S=0, S'=0$ is given by $L=S-S'=0$.\\
Using \eqref{eq:1}, \eqref{eq:2}, the required equation is
\begin{align}
...
\begin{figure}[!h]
 ...
 \caption{S=0 (Green), S'=0 (Blue), L=0 (Red)}
 \label{plot}
\end{figure}
\end{document}