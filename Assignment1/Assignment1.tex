...
\end{equation}
\begin{equation}
||\boldsymbol{a}||=\sqrt{(1)^{2} + (1)^{2} + (-2)^{2}}=\sqrt{6}
\end{equation}
...
\begin{equation}
\boldsymbol{\hat{n}}=\dfrac{\boldsymbol{v}}{||\boldsymbol{v}||}
\label{eq:def}
\end{equation}
Using \eqref{eq:def}, 
\begin{equation}
\boldsymbol{\hat{u}}=\dfrac{\boldsymbol{a}}{||\boldsymbol{a}||}
\end{equation}
\begin{equation}
\therefore \boldsymbol{\hat{u}}=\dfrac{1}{\sqrt{6}}\begin{pmatrix}
1 \\
1 \\
-2 
\end{pmatrix}
